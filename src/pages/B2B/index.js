      ...
      <div  style={{backgroundColor:"#c8d8e4"}}>
        ...
        <div className='row pt-5 pb-5 align-items-center'>
          <div className='col-12 col-md-6 col-lg-6'>
            <img alt=' ' className='card-img-top rounded-3 ' width={200} src='https://cdn.xxl.thumbs.canstockphoto.com/service-3d-human-character-and-service-concept-3d-render-illustration-clipart_csp5757531.jpg' />
          </div>
          <div className='col-12 col-md-6 col-lg-6'>
            <div className='shadow rounded-3   p-4' style={{backgroundColor:"#ffff"}}>
